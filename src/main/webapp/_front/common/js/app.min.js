...
define("modules/app/main", ["lib/zepto/zepto", "lib/zepto/selector", "lib/zepto/touch", "system/util/objectUtil", "units/globalAudio", "lib/zepto/coffee", "./statistics"],
function(require, exports, module) {
        ...
        function() {
            ...
            function() {
                i && (i = !1, c ? (b._isDisableFlipPage = !0, a.style.webkitTransition = "-webkit-transform 0.4s ease-out", c.style.webkitTransition = "-webkit-transform 0.4s ease-out", Math.abs(h) > Math.abs(g) && Math.abs(h) > 100 ? (j ? (a.style.webkitTransform = "scale(0.2)", c.style.webkitTransform = "translateY(0px)") : (a.style.webkitTransform = "scale(0.2)", c.style.webkitTransform = "translateY(0px)"), setTimeout(function() {
                    ...
                    b.$currentPage = $(c).trigger("current"),
                    $(a).trigger("hide")
                },
...
define("modules/form/main", ["lib/zepto/zepto", "units/maskLayer", "lib/zepto/selector", "lib/zepto/touch", "lib/zepto/data", "modules/app/main", "units/globalAudio", "modules/app/statistics", "lib/iscroll/iscroll"],
function(a, b, c) {
    var d = a("lib/zepto/zepto"),
    d = a("units/maskLayer"),
...
define("modules/link/main", ["lib/zepto/zepto", "lib/zepto/selector", "units/maskLayer", "lib/zepto/touch", "lib/zepto/data", "modules/app/main", "units/globalAudio", "modules/app/statistics"],
function(a, b, c) {
    var d = a("lib/zepto/zepto"),
...
define("modules/map/main", ["lib/zepto/zepto", "units/yunlaiMap", "lib/zepto/selector", "lib/zepto/touch", "http://api.map.baidu.com/getscript?v=1.4&ak=&services=&t=20140320104737", "modules/app/main", "units/globalAudio", "modules/app/statistics"],
function(require, exports, module) {
    var $ = require("lib/zepto/zepto"),
...
define("modules/video/main", ["lib/zepto/zepto", "lib/zepto/touch", "units/maskLayer", "lib/zepto/selector", "lib/zepto/data", "./youkuVideo", "lib/youku/jsapi", "modules/app/main", "units/globalAudio", "modules/app/statistics", "lib/zepto/coffee", "system/util/objectUtil"],
function(a, b, c) {
    var d = a("lib/zepto/zepto"),
    d = a("lib/zepto/touch"),
    d = a("units/maskLayer"),
...
function(a, b, c) {
    ...
    f.prototype.play = function() {
        this._$globalAudio.is(".z-play") || (this.audio.play(), this._$globalAudio.removeClass("z-pause").addClass("z-play"), this._showTip("开启"), this.playState = "playing")
    },
    ...
    function() {
        ...
        b.prototype.addMarker = function(a) {
            ...
            function() {
                ...
                b._baiduMap.infoWindow && !window._yunlaiMap_initRouted && (window._yunlaiMap_initRouted = !0, d(b._baiduMap.infoWindow.contentMain).delegate(".navigationButtons a", "click",
                function() {
